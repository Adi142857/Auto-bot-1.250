...
import com.aditya.Auto_bot_22.models.Action;
import com.aditya.Auto_bot_22.models.SaveCustomeMessage;
...
public class MyNotifiService extends NotificationListenerService {
    ...
    public static final String TAG = "Aditya";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.i("Aditya Dev", "Service is started" + "-----");
    ...
    public void onNotificationPosted(StatusBarNotification sbn) {
        ...
        if (action != null) {
            ...
            Log.i(TAG, "Tak failed..please try again");
        }
        ...
        try {
           ...
           Toast.makeText(MyNotifiService.this, "Unresolvable notification maybe there's a default setting enabled in your system", Toast.LENGTH_SHORT).show();
       }
